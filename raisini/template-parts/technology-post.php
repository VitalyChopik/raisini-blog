<article class="box__post technology__box <?php echo $args['class']; ?>">
  ...
  <?php  $category = get_the_category(); ?>
    ...
    <div class="box__info technology__box-info"><span class="box__data technology__box-data"><?php the_time('F d'); ?></span><span class="box__read technology__box-read"><?php echo reading_time(); ?> mins read</span></div>
  </div>

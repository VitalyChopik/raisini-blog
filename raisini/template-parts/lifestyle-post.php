<article class="box__post lifestyle__box <?php echo $args['class']; ?>">
  ...
  <?php  $category = get_the_category(); ?>
    ...
    <div class="box__info lifestyle__box-info"><span class="box__data lifestyle__box-data"><?php the_time('F d'); ?></span><span class="box__read lifestyle__box-read"><?php echo reading_time(); ?> mins read</span></div>
  </div>

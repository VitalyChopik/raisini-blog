<div class="swiper-slide bisiness__box">
  ...
  <div class="bisiness__box-text">
    ...
    <div class="box__info bisiness__box-info"><span class="box__data bisiness__box-data"><?php the_time('F d'); ?></span><span class="box__read bisiness__box-read"><?php the_field('mins_read');?> mins read</span></div>
  </div>
</div>
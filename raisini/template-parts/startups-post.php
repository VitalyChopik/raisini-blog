<div class="box__post startups__box <?php echo $args['class']; ?>">
  ...
  <?php  $category = get_the_category(); ?>
    ...
    <div class="box__info startups__box-info"><span class="box__data startups__box-data"><?php the_time('F d'); ?></span><span class="box__read startups__box-read"><?php the_field('mins_read');?> mins read</span></div>
  </div>
</div>